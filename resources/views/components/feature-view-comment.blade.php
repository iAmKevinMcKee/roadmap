...
<article class="flex gap-4">
    <div class="flex items-center justify-center w-10 h-10 font-medium rounded-full shrink-0 bg-gradient-to-br from-violet-500 to-purple-600 text-white text-sm">
